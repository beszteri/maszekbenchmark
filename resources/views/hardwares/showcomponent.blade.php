        ...
        <div class="row">
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
                <div
                    ...
                    <a href="/hardwares/{{strtolower($hardware->getPart())}}s/1" class="btn btn-secondary">Go Back</a>
                </div>
                ...
                <br>
                <hr>
                <h4>There are {{count($components)}} measured {{$hardware->getModel()}} in the database</h4>
                <hr>
            </main>
        </div>
    </div>
